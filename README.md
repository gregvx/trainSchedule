# trainSchedule
I couldn’t do any of the bonus stuff due to time constrains, but I did notice a peculiar little issue that I fixed and commented on in the code but wanted to talk about here:
...
By using an if statement, we check for that scenario and correct the cariable that holds the time of the next arrival.